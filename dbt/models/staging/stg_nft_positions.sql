...
select
    ...
    cast(wallet_source as varchar) as wallet_source,
    ...
    try_cast(range_width_pct as double) as range_width_pct,
    coalesce(try_cast(is_full_range as boolean), false) as is_full_range,
